Subroutine Read_InputFile_GD(filename,rlat,rlon)
...
! CALL mdatePminPsec (iYrS,iMonS,iDayS,iHrS, iMinS,iSecS, DayS_8, 1)
...
read(999,*) dum     ! KRDO: D.O. reaeration coefficient (m/s)
KRDO = dum 
