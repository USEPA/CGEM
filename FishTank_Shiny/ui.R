      ...
      tabsetPanel(
        ...
        tabPanel("Select parameters", 
          ...
          column(width = 6, 
            ...
            wellPanel(id = "specifics", style = "overflow-y:scroll; max-height: 400px; background-color:#daf1da",
          ...
          column(width = 6, 
            ...
            wellPanel(id = "phytoplankton", style = "overflow-y:scroll; max-height: 400px; background-color:#daf1da", 
              ...
              fluidRow(
                column(width = 4, numericInput('umax_1', label = NULL, 1.12, width = '200px', step = 0.01)),
                column(width = 4, numericInput('umax_2', label = NULL, 1.12, width = '200px', step = 0.01)),
                column(width = 4, numericInput('umax_3', label = NULL, 1.12, width = '200px', step = 0.01)),
                column(width = 4, numericInput('umax_4', label = NULL, 1.12, width = '200px', step = 0.01)),
                column(width = 4, numericInput('umax_5', label = NULL, 1.12, width = '200px', step = 0.01)),
                column(width = 4, numericInput('umax_6', label = NULL, 1.12, width = '200px', step = 0.01))
              ),
              ...
              fluidRow(
                column(width = 4, numericInput('QmaxN_1', label = NULL, 6.85e-9, width = '200px', step = 1e-10)),
                column(width = 4, numericInput('QmaxN_2', label = NULL, 6.85e-9, width = '200px', step = 1e-10)),
                column(width = 4, numericInput('QmaxN_3', label = NULL, 6.85e-9, width = '200px', step = 1e-10)),
                column(width = 4, numericInput('QmaxN_4', label = NULL, 6.85e-9, width = '200px', step = 1e-10)),
                column(width = 4, numericInput('QmaxN_5', label = NULL, 6.85e-9, width = '200px', step = 1e-10)),
                column(width = 4, numericInput('QmaxN_6', label = NULL, 6.85e-9, width = '200px', step = 1e-10))
              ),
              ...
              fluidRow(
                column(width = 4, numericInput('Kn_1', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Kn_2', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Kn_3', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Kn_4', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Kn_5', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Kn_6', label = NULL, 1.13, width = '200px', step = 1e-4))
              ),
              p(strong(HTML('Kp: half-saturation constant for P, mmol P m<sup>-3</sup>'))),
              fluidRow(
                column(width = 4, numericInput('Kp_1', label = NULL, 0.51, width = '200px', step = 1e-5)),
                column(width = 4, numericInput('Kp_2', label = NULL, 0.51, width = '200px', step = 1e-5)),
                column(width = 4, numericInput('Kp_3', label = NULL, 0.51, width = '200px', step = 1e-5)),
                column(width = 4, numericInput('Kp_4', label = NULL, 0.51, width = '200px', step = 1e-5)),
                column(width = 4, numericInput('Kp_5', label = NULL, 0.51, width = '200px', step = 1e-5)),
                column(width = 4, numericInput('Kp_6', label = NULL, 0.51, width = '200px', step = 1e-5))
              ),
              p(strong(HTML('Ksi: half-saturation constant for Si uptake, mmol Si m<sup>-3</sup>'))),
              fluidRow(
                column(width = 4, numericInput('Ksi_1', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Ksi_2', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Ksi_3', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Ksi_4', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Ksi_5', label = NULL, 1.13, width = '200px', step = 1e-4)),
                column(width = 4, numericInput('Ksi_6', label = NULL, 1.13, width = '200px', step = 1e-4))
              ),
              ...
              fluidRow(
                column(width = 4, numericInput('volcell_1', label = NULL, 513, width = '200px', step = 1)),
                column(width = 4, numericInput('volcell_2', label = NULL, 513, width = '200px', step = 1)),
                column(width = 4, numericInput('volcell_3', label = NULL, 513, width = '200px', step = 1)),
                column(width = 4, numericInput('volcell_4', label = NULL, 513, width = '200px', step = 1)),
                column(width = 4, numericInput('volcell_5', label = NULL, 513, width = '200px', step = 1)),
                column(width = 4, numericInput('volcell_6', label = NULL, 513, width = '200px', step = 1))
              ),
              ...
              fluidRow(
                column(width = 4, numericInput('Athresh_1', label = NULL, 7e07, width = '200px', step = 1e6)),
                column(width = 4, numericInput('Athresh_2', label = NULL, 7e07, width = '200px', step = 1e6)),
                column(width = 4, numericInput('Athresh_3', label = NULL, 7e07, width = '200px', step = 1e6)),
                column(width = 4, numericInput('Athresh_4', label = NULL, 7e07, width = '200px', step = 1e6)),
                column(width = 4, numericInput('Athresh_5', label = NULL, 7e07, width = '200px', step = 1e6)),
                column(width = 4, numericInput('Athresh_6', label = NULL, 7e07, width = '200px', step = 1e6))
              ),
          ...
          column(width = 6, 
            ...
            wellPanel(id = "zooplankton", style = "overflow-y:scroll; max-height: 400px; background-color:#daf1da", 
              ...
              fluidRow(
                ...
                column(width = 6, numericInput('ZQn_2', label = NULL, 1.57e-7, width = '1200px', step = 1e-8))
              ),
              ...
              fluidRow(
                ...
                column(width = 6, numericInput('Zumax_2', label = NULL, 2.98e7, width = '1200px', step = 1e3))
              ),
        ...
        tabPanel("Select initial conditions", 
          ...
          column(width = 12, 
            ...
            wellPanel(id = "other", style = "overflow-y:scroll; max-height: 800px; background-color:#daf1da", 
              ...
              fluidRow(
                column(width = 2, numericInput('Qn1', label = NULL, 0.30649887e-8, width = '200px', step = 1e-9)),
                column(width = 2, numericInput('Qn2', label = NULL, 0.30649887e-8, width = '200px', step = 1e-9)),
                column(width = 2, numericInput('Qn3', label = NULL, 0.30649887e-8, width = '200px', step = 1e-9)),
                column(width = 2, numericInput('Qn4', label = NULL, 0.30649887e-8, width = '200px', step = 1e-9)),
                column(width = 2, numericInput('Qn5', label = NULL, 0.30649887e-8, width = '200px', step = 1e-9)),
                column(width = 2, numericInput('Qn6', label = NULL, 0.30649887e-8, width = '200px', step = 1e-9))
              ),
              
              p(strong('Phytoplankton cell quota for phosphorus, Qp1:Qp6')),
              fluidRow(
                column(width = 2, numericInput('Qp1', label = NULL, 0.19438481e-9, width = '200px', step = 1e-10)),
                column(width = 2, numericInput('Qp2', label = NULL, 0.19438481e-9, width = '200px', step = 1e-10)),
                column(width = 2, numericInput('Qp3', label = NULL, 0.19438481e-9, width = '200px', step = 1e-10)),
                column(width = 2, numericInput('Qp4', label = NULL, 0.19438481e-9, width = '200px', step = 1e-10)),
                column(width = 2, numericInput('Qp5', label = NULL, 0.19438481e-9, width = '200px', step = 1e-10)),
                column(width = 2, numericInput('Qp6', label = NULL, 0.19438481e-9, width = '200px', step = 1e-10))
              ),
