!***********************************************************************
  ...
  !---------------------------------------------------------- 
    ...
    REAL, INTENT(IN) :: Z2
    REAL, INTENT(IN) :: TEMP
    REAL, DIMENSION(9),INTENT(OUT):: RC
...
!---------------------------------------------     
    ...
    RNO3 = ( Y1 / X1 * R11 + Y2 / X2 * R21 ) - ( GAM14 * R12 + GAM24 * R22 )
    SUM_NO3 = SUM_NO3 + ( GAM14 * R12 + GAM24 * R22 )/365.
    !write(6,*) SUM_N2, SUM_NO3
 
    RALK = (A14 * R12 + A24 * R22)

    RNH4 = 0. !( Y1 / X1 * R11 + Y2 / X2 * R21 )
