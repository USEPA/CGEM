...
!WQEM Parameters
    ...
    CALL DEFRAT( FILE_ID, 'KE', KE )
    CALL DEFRAT( FILE_ID, 'KECHL', KECHL )
...
#ifdef DEBUG
write(6,*) VARIABLE,VARIABLE_NAMES(VARIABLE),VARIABLE_DESCRIPTIONS( VARIABLE),VARIABLE_UNITS( VARIABLE )
#endif
...
write(6,*) "After Extra_Vars"
    ...
    ! Write h
    ERR = ncdf_PUT_VAR_REAL( FILE_ID, H_VAR, H )
    ...
    ERR = ncdf_PUT_VAR_REAL( FILE_ID, AREA_VAR, AREA )
  ...
  !
  SUBROUTINE OPEN_FILE( NAME, VARIABLES, EXTRA_VARIABLES1, FIRST_TIMESTEP )
    USE OUTPUT 
    IMPLICIT NONE
    include 'netcdf.inc'
...
!    EXTERNAL NF__OPEN, NF_INQ_VARID, NF_GET_ATT_INT, NF_GET_ATT_REAL
    ...
    DO VARIABLE = 1, VARIABLES
#ifdef DEBUG
write(6,*) Variable, VARIABLE_NAMES( VARIABLE ), F_VAR( VARIABLE ) 
#endif
    ...
    DO VARIABLE = 1, EXTRA_VARIABLES
#ifdef DEBUG
write(6,*) Variable, EXTRA_VARIABLE_NAMES( VARIABLE ), EXTRA_VAR( VARIABLE )
#endif
  ...
  SUBROUTINE WRITE_DATA( IMSTART, IM, JMSTART, JM, KMSTART, KM, VARIABLES, TIMESTEP, F ) 
    USE OUTPUT 
    IMPLICIT NONE
