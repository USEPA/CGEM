...
read(999,*) KE            ! KE: Background light attenuation [m^-1]
read(999,*) KECHL         ! KECHL: Light attenuation factor for chlorophyll-a [m^2-kg^-1]
read(999,*) 
...
call MPI_BCAST(KRDO,1,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
