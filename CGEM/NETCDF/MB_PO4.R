...
for (t in 1:nt){
  PO4<-ncvar_get(nc,"PO4",start=c(1,1,1,t),count=c(nx,ny,nz,1))
  ...
  Qp1<-ncvar_get(nc,"Qp1",start=c(1,1,1,t),count=c(nx,ny,nz,1))
  Qp2<-ncvar_get(nc,"Qp2",start=c(1,1,1,t),count=c(nx,ny,nz,1))
  Qp3<-ncvar_get(nc,"Qp3",start=c(1,1,1,t),count=c(nx,ny,nz,1))
  ...
  Qp4<-ncvar_get(nc,"Qp4",start=c(1,1,1,t),count=c(nx,ny,nz,1))
  Qp5<-ncvar_get(nc,"Qp5",start=c(1,1,1,t),count=c(nx,ny,nz,1))
  Qp6<-ncvar_get(nc,"Qp6",start=c(1,1,1,t),count=c(nx,ny,nz,1))
