...
Tot[t] = DICtot[t] + Atot[t] + Ztot[t] + OMA_tot[t] + OMZ_tot[t] + OMR_tot[t] + OMBC_tot[t]
if(t==1) Toti = Tot[i]
cat(t,DICtot[t],Atot[t],Ztot[t],OMA_tot[t],OMZ_tot[t],OMR_tot[t],OMBC_tot[t],Tot[t],Tot[t]-Tot[max(t-1,1)],(Tot[t]-Toti)/Toti*100,"\n")
}
