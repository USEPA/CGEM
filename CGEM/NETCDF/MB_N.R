...
NH4<-ncvar_get(nc,"NH4",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
NO3<-ncvar_get(nc,"NO3",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
...
Qn1<-ncvar_get(nc,"Qn1",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
Qn2<-ncvar_get(nc,"Qn2",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
Qn3<-ncvar_get(nc,"Qn3",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
...
Qn4<-ncvar_get(nc,"Qn4",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
Qn5<-ncvar_get(nc,"Qn5",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
Qn6<-ncvar_get(nc,"Qn6",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
...
s_y1A <- ncvar_get(nc,"s_y1A",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
s_y2A <- ncvar_get(nc,"s_y2A",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
...
s_y1Z <- ncvar_get(nc,"s_y1Z",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
s_y2Z <- ncvar_get(nc,"s_y2Z",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
...
R_11<-ncvar_get(nc,"R_11",start=c(1,1,1,t),count=c(nx,ny,nz-1,1))
