...
! River vars
           ...
           if (nBC.gt.0 .AND. broadcast_bc) then
                if (Which_code.eq."CGEM") then
                   ...
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC8), TC_8, startBCIndex(eBC8), BC8A, BC8B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC9), TC_8, startBCIndex(eBC9), BC9A, BC9B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC10), TC_8, startBCIndex(eBC10), BC10A, BC10B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC11), TC_8, startBCIndex(eBC11), BC11A, BC11B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC12), TC_8, startBCIndex(eBC12), BC12A, BC12B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC13), TC_8, startBCIndex(eBC13), BC13A, BC13B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC14), TC_8, startBCIndex(eBC14), BC14A, BC14B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC15), TC_8, startBCIndex(eBC15), BC15A, BC15B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC16), TC_8, startBCIndex(eBC16), BC16A, BC16B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC17), TC_8, startBCIndex(eBC17), BC17A, BC17B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC18), TC_8, startBCIndex(eBC18), BC18A, BC18B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC19), TC_8, startBCIndex(eBC19), BC19A, BC19B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC20), TC_8, startBCIndex(eBC20), BC20A, BC20B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC21), TC_8, startBCIndex(eBC21), BC21A, BC21B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC22), TC_8, startBCIndex(eBC21), BC22A, BC22B, bc_tc1, bc_tc2)
                   call retrieveBookendBCVar(boundaryconcentration_info(eBC23), TC_8, startBCIndex(eBC21), BC23A, BC23B, bc_tc1, bc_tc2)
               else
                  WRITE(6,*) "Model ", Which_code," not found in Get_Vars.F90"
                  WRITE(6,*) "Exiting."
                  STOP
...
!              call MPI_BCAST(S2,im*jm*nsl,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
        ...
        if (broadcast_bc) then
            ...
            if(Which_code.eq."CGEM") then
                ...
                call MPI_BCAST(BC8A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC9A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC10A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC11A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC12A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC13A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC14A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC15A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC16A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC17A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC18A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC19A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC20A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC21A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC22A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC23A,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                ...
                call MPI_BCAST(BC8B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC9B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC10B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC11B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC12B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC13B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC14B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC15B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC16B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC17B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC18B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC19B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC20B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC21B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC22B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
                call MPI_BCAST(BC23B,nBC,MPI_REAL,0,MPI_COMM_WORLD,mpierr)
            else
                  WRITE(6,*) "Model ", Which_code," not found in Get_Vars.F90"
                  WRITE(6,*) "Exiting."
                  STOP
      ...
      if (Which_gridio.eq.1)then
        ...
        if (nBC .gt. 0)then
          if(Which_code.eq."CGEM") then 
              ...
              call interp(BC8A, BC8B, bc_tc1, bc_tc2, TC_in, BC8)
              call interp(BC9A, BC9B, bc_tc1, bc_tc2, TC_in, BC9)
              call interp(BC10A, BC10B, bc_tc1, bc_tc2, TC_in, BC10)
              call interp(BC11A, BC11B, bc_tc1, bc_tc2, TC_in, BC11)
              call interp(BC12A, BC12B, bc_tc1, bc_tc2, TC_in, BC12)
              call interp(BC13A, BC13B, bc_tc1, bc_tc2, TC_in, BC13)
              call interp(BC14A, BC14B, bc_tc1, bc_tc2, TC_in, BC14)
              call interp(BC15A, BC15B, bc_tc1, bc_tc2, TC_in, BC15)
              call interp(BC16A, BC16B, bc_tc1, bc_tc2, TC_in, BC16)
              call interp(BC17A, BC17B, bc_tc1, bc_tc2, TC_in, BC17)
              call interp(BC18A, BC18B, bc_tc1, bc_tc2, TC_in, BC18)
              call interp(BC19A, BC19B, bc_tc1, bc_tc2, TC_in, BC19)
              call interp(BC20A, BC20B, bc_tc1, bc_tc2, TC_in, BC20)
              call interp(BC21A, BC21B, bc_tc1, bc_tc2, TC_in, BC21)
              call interp(BC22A, BC22B, bc_tc1, bc_tc2, TC_in, BC22)
              call interp(BC23A, BC23B, bc_tc1, bc_tc2, TC_in, BC23)
          else
                  WRITE(6,*) "Model ", Which_code," not found in Get_Vars.F90"
                  WRITE(6,*) "Exiting."
                  STOP
