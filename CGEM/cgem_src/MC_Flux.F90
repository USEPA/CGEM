...
!    integer, intent(in) :: istep, my_imstart, my_imend
    integer, intent(in) :: istep
    integer, intent(in) :: istep_wait, print_ave, fm(im,jm)
...
!     call WRITE_FLUX_MC( my_imstart, my_im, 1, jm, i_out, SUM_O2F(1:myim,1:jm) )
